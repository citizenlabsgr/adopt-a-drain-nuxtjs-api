...
module.exports = class CreateFunctionSignin001 extends Step {
  constructor(baseName, baseVersion) {
    ...
    this.sql = `CREATE OR REPLACE FUNCTION ${this.name}(guest_token TEXT,credentials JSON, timeoutin integer DEFAULT 1800 ) RETURNS JSONB
            ...
            SELECT ${this.baseKind}_${this.baseVersion}.sign(row_to_json(r), ${this.baseKind}_${this.baseVersion}.get_jwt_secret()) AS token into _user_token
                 FROM (
                   SELECT
                     ...
                     pk as jti,
                     tk as key,
                     (extract(epoch from now()) + timeoutin) as exp
