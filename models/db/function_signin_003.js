...
module.exports = class CreateFunctionSignin extends Step {
  constructor(baseName, baseVersion) {
    ...
    this.method = 'POST';
    this.params = 'guest_token TEXT,credentials JSON, lapse_in_millisec integer DEFAULT 1800';
    this.baseKind = 'base';
    ...
    BEGIN
      ...
      -- [Validate Token]
      _token := base_${this.baseVersion}.validate_token(guest_token, 'api_guest') ;
