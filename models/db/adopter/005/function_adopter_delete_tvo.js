...
module.exports = class FunctionAdopterDeleteTvo extends Step {
  constructor(baseName, baseVersion) {
    ...
    this.params = 'token TOKEN, id VARCHAR, owner OWNER_ID';
    this.method = 'DELETE';
    ...
    BEGIN
      -- [Function: get api_${this.version}.adopter given user_token TOKEN, id VARCHAR, owner OWNER_ID]
