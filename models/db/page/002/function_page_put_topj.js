...
module.exports = class FunctionPagePutTopj extends Step {
  constructor(baseName, baseVersion) {
    ...
    Declare groupId TEXT := '${groupType}';
    ...
    BEGIN
      ...
      -- [Prefix the primary key]
        ...
        id := format('("%s#%s","name#%s")', groupId, id.pk, id.sk)::PRIMARYKEY;
