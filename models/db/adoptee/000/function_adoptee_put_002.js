...
module.exports = class FunctionAdopteePut extends Step {
  constructor(baseName, baseVersion) {
    ...
    this.params = 'token TOKEN, id IDENTITY, form JSON, _owner OWNER_ID';
    ...
    BEGIN
      ...
      -- [Function: adoptee given user_token TOKEN, id IDENTITY, form JSON, _owner OWNER_ID]
      ...
      */
      ...
      chelate := chelate || key_map || format('{"pk": "${this.pk}#%s"}',id)::JSONB;    

      -- [Execute update]

      result := ${this.baseKind}_${this.baseVersion}.update(chelate, _owner); 
