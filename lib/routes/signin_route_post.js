...
module.exports = {
  ...
  handler: async function (req) {
    ...
    let form ;
    console.log('req.headers.api_options ',req.headers.api_options);
    const test =     req.headers.api_options.test || false;
    const apiDebug = req.headers.api_options.debug || false;
    try {  
      ...
      /* $lab:coverage:on$ */
      // new ApiDebug(apiDebug).show(req.headers,req.payload);
