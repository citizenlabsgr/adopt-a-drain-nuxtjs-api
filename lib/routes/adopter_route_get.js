...
module.exports = {
  ...
  handler: async function (req) {
    ...
    try {
      ...
      result['error'] = err;
      console.error('/adopter GET TEST (TOKEN, JSON, OWNER_ID) err', err);
    }
    try {
      ...
      let queryObj;
      queryObj = {
        text: 'select * from api_0_0_1.adopter($1::TOKEN,$2::IDENTITY,$3::OWNER_ID)',
        values: [token,
                 id,
                 owner]
      };
      ...
      result.msg = 'Unknown Error';
      result['error'] = err;
      console.error('/adopter GET (TOKEN, IDENTITY, OWNER_ID) err', err);
    } finally {
