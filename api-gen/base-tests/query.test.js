...
module.exports = class FunctionQueryTest extends Step {
  constructor(kind, baseVersion) {
    ...
    this.sql = `BEGIN;
      ...
      -- 1
  /* work around  has_function doesnt work with user defined types
      SELECT has_function(
          ...
          'DB Function query (jsonb, owner_id) should exist'
...
*/
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"one","sk":"*","owner":"duckduckgoose","mbr": ${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID) - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"two","sk":"const#ADOPTEE","owner":"duckduckgoose","mbr":${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID) - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"three","sk":"*","mbr":${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID) - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"one","sk":"const#ADOPTEE","mbr":${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"two","sk":"*","owner":"duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"three","sk":"const#ADOPTEE","owner":"goose"}'::JSONB
        ,'("goose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"one","sk":"*"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"pk":"two","sk":"const#ADOPTEE"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"*","mbr": ${this.mbr}, "owner":"duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"3","owner":"goose", "mbr": ${this.mbr}}'::JSONB
        ,'("goose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"*","mbr": ${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"1", "mbr": ${this.mbr}}'::JSONB	
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"*", "owner":"duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"2", "owner":"duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"*"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"sk":"const#ADOPTEE","tk":"3"}'::JSONB 
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"3","yk":"*", "owner":"goose", "mbr": ${this.mbr}}'::JSONB
        ,'("goose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"1","yk":"const#ADOPTEE", "owner":"duckduckgoose", "mbr": ${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"2","yk":"*", "mbr": ${this.mbr}}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"3","yk":"const#ADOPTEE", "mbr": ${this.mbr}}'::JSONB
        ,'("goose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query( '{"xk":"1","yk":"*", "owner": "duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"2","yk":"const#ADOPTEE", "owner": "duckduckgoose"}'::JSONB
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"3","yk":"*"}'::JSONB 
        ,'("goose")'::OWNER_ID)  - 'selection',
      ...
      SELECT is (
        ...
        ${this.kind}_${this.version}.query('{"xk":"1","yk":"const#ADOPTEE"}'::JSONB 
        ,'("duckduckgoose")'::OWNER_ID)  - 'selection',
