    ...
    module.exports = class FunctionAdopteePutToijUserTokenTest extends Step {
    ...
    BEGIN;
      ...
      SELECT plan(1);
        ...
        SELECT has_function(
            ...
            'DB Function PUT adoptee (TOKEN,OWNER_ID,IDENTITY,JSONB) exists'
        ...
        */
        ...
        SELECT is (
            ...
            'DB adoptee(TOKEN,OWNER_ID,IDENTITY,JSONB) PUT api_user 200 0_0_1'::TEXT
