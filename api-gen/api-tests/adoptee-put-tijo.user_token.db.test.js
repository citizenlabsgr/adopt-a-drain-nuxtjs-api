    ...
    module.exports = class FunctionAdopteePutTijoUserTokenTest extends Step {
    ...
    BEGIN;
      ...
      SELECT plan(1);
        ...
        SELECT has_function(
            ...
            'DB Function PUT adoptee (TOKEN,IDENTITY,JSONB,OWNER_ID) exists'
        ...
        */
        ...
        SELECT is (
            ...
            'DB adoptee(TOKEN,IDENTITY,JSONB,OWNER_ID) PUT api_user 200 0_0_1'::TEXT
