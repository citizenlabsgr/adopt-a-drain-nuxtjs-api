    ...
    module.exports = class FunctionAdopteePutTijUserTokenTest extends Step {
    ...
    BEGIN;
      ...
      SELECT plan(2);
        ...
        SELECT has_function(
            ...
            ARRAY[TOKEN,IDENTITY,JSON,OWNER_ID],
      
            'DB Function PUT adoptee (TOKEN,IDENTITY,JSON,OWNER_ID) exists'
